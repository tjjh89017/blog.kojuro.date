...
今天看到 IETF 上有人提了一份 [IPv8 draft](https://datatracker.ietf.org/doc/draft-thain-ipv8/)，快速掃過一遍就知道沒料 — 技術上站不住腳，該解的問題也沒真的解到。不過我還是丟給 Claude 聊聊，一方面確認自己的直覺，另一方面想看看還能聊出什麼別的東西。

三秒後 Claude 也同意：沒料。社群反應也是一面倒的嘲諷。
